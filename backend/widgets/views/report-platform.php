<?php
//exit('<pre>'.print_r($platforms,true).'</pre>');
?>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="saw-chart-circle__symbol"
                                     style="--saw-chart-circle__symbol--color: <?= $platform['color'] ?>"></div>
                                <div class="ps-2">
                                    <?= mb_strlen($platform['label']) > 10 ? mb_substr($platform['label'], 0, 10) . '...' : $platform['label'] ?>
                                </div>
                            </div>
                        </td>
                        <td class="text-center"><span
                                    class="sa-nav__menu-item-badge badge badge-sa-pill badge-sa-theme-user"><?= $platform['value'] ?></span>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
