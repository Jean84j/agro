                        ...
                        <div class="col-6 col-md-3 col-lg-2">
                            <div class="site-footer__widget footer-links">
                                ...
                                <ul class="footer-links__list">
                                    ...
                                    <li class="footer-links__item"><a href="" class="footer-links__link">Повернення</a></li>
                                    <li class="footer-links__item"><a href="" class="footer-links__link">Карта сайту</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 col-lg-2">
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="site-footer__widget footer-newsletter">
                                ...
                                <form action="" class="footer-newsletter__form">
                                    ...
                                    <input type="text" class="footer-newsletter__form-input form-control" id="footer-newsletter-address" placeholder="Електронна адреса...">
