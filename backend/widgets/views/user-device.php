...
<div class="col-12 col-xxl-3 d-flex">
    ...
    >
        <div class="sa-widget-header saw-chart-circle__header">
            <h2 class="sa-widget-header__title">Девайси користувачів</h2>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-2">Мобільний</div>
                                </div>
                            </td>
                            <td class="text-center"><span class="sa-nav__menu-item-badge badge badge-sa-pill badge-sa-theme-user"><?php echo $mobil?></span></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-2">Десктоп</div>
                                </div>
                            </td>
                            <td class="text-center"><span class="sa-nav__menu-item-badge badge badge-sa-pill badge-sa-theme-user"><?php echo $desktop?></span></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-2">Не визначений</div>
                                </div>
                            </td>
                            <td class="text-center"><span class="sa-nav__menu-item-badge badge badge-sa-pill badge-sa-theme-user"><?php echo $no_detect?></span></td>
                        </tr>
                </tbody>
            </table>
        </div>
